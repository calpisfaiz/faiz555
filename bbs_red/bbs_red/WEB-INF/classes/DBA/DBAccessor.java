...
//======================================================Search======================================================		
	public ArrayList<ThreadBeans> searchNo(String data){
		...
		try{
			...
			String sql="select thread_no,thread_title,thread_username,thread_date,thread_res from thread where thread_no like '%"+data+"%' order by thread_no";		//select文oracleに入力
			getConnection();
		...
		try{
			String sql="select thread_no,thread_title,thread_username,thread_date,thread_res from thread where thread_username like '%"+data+"%' order by thread_no";		//select文oracleに入力
			getConnection();
		...
		try{
			String sql="select thread_no,thread_title,thread_username,thread_date,thread_res from thread where thread_title like '%"+data+"%' order by thread_no";		//select文oracleに入力
			getConnection();
			System.out.println("searchNo接続した");
			Statement st=conn.createStatement();
